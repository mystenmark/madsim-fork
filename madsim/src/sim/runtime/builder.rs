...
impl Builder {
    ...
    pub fn worker_threads(&mut self, val: usize) -> &mut Self {
        info!("worker_threads is ignored in the simulator");
        self
    }
    ...
    pub fn max_blocking_threads(&mut self, val: usize) -> &mut Self {
        info!("max_blocking_threads is ignored in the simulator");
        self
    }
    ...
    pub fn thread_stack_size(&mut self, val: usize) -> &mut Self {
        info!("thread_stack_size is ignored in the simulator");
        self
    }
    ...
    pub fn thread_keep_alive(&mut self, duration: Duration) -> &mut Self {
        info!("thread_keep_alive is ignored in the simulator");
        self
    }
    ...
    pub fn global_queue_interval(&mut self, val: u32) -> &mut Self {
        info!("global_queue_interval is ignored in the simulator");
        self
    }
    ...
    pub fn event_interval(&mut self, val: u32) -> &mut Self {
        info!("event_interval is ignored in the simulator");
        self
    }
    ...
    /// not necessary in the simulator
    pub fn start_paused(&mut self, start_paused: bool) -> &mut Self {
        panic!("start_paused is unnecessary in the simulator");
    }
